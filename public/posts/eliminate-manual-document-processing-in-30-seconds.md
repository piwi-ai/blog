...
At [Piwi.ai](https://piwi.ai), we believe that if you can't use a document automation tool on your first day, it's too complicated. 
...
<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:activity:7430967592716210176" height="630" width="100%" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>
...
Drag and drop the unstructured documents you need to pull data from. This could be a cell phone picture of a driver's license, a scanned utility bill, and a messy invoice. You don't need to tell the system where to look; just provide the files.

### Step 3: Generate the Finished Document (10 Seconds)

Click generate. Piwi.ai reads the unstructured sources, cross-validates the data to ensure consistency (e.g., making sure the name on the ID matches the name on the bill), and maps that extracted data directly into your clean PDF template. 

You download a finalized, signature-ready document.
